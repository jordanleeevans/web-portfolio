...
export default function LgButtons() {
  ...
  return (
    ...
    >
      <Link
        href="#contact"
        className="group bg-gray-900 text-white px-9 py-3 flex items-center justify-center rounded-full font-medium text-lg transition-all duration-300 hover:bg-gray-800 hover:shadow-xl outline-none hover:scale-105 active:scale-95 border border-black/10 dark:bg-gray-800 dark:text-gray-50"
        onClick={() => {
      ...
      <a
        ...
        target="_blank"
      >
        <BsLinkedin className="text-2xl text-gray-900 dark:text-gray-200" />
      </a>
      <a
        className="bg-white p-[0.875rem] text-gray-700 flex items-center gap-2 rounded-full hover:bg-gray-100 hover:shadow-xl outline-none hover:scale-105 active:scale-95 border border-black/10 dark:bg-gray-500 dark:text-gray-50"
